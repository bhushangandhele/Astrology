...
const DB_PATH = path_1.default.resolve(__dirname, '../../astro.db');
const SCHEMA_PATH = path_1.default.resolve(__dirname, '../models/schema.sql');
...
function initializeDatabase() {
    try {
        const schemaSql = fs_1.default.readFileSync(SCHEMA_PATH, 'utf8');
